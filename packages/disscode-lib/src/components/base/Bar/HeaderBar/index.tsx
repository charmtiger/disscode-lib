...
const DarkBackIcon = <Image src={require('./images/back_light.png')} className='header_bar__back_button__image M-display-block' />;
const LightBackIcon = <Image src={require('./images/back_dark.png')} className='header_bar__back_button__image M-display-block' />;
@observer
        ...
        {({}) => {
          ...
          return (
            <View className='header_bar__view'>
              ...
              <Container
                src={require('./images/header_bg.png')}
